...
import json
import pickle
from . modules.mof_cm import MOF
from . modules.linkers_cm import Linkers
from . modules.user_cm import USER
from . modules.other_cm import (copy, settings_from_file, load_objects, write_csv_results)
...
def export_results(EXECUTION_FOLDER, user):
    from . modules.other_cm import load_objects
    import pandas as pd
